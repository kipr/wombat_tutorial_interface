...
meta:
  ...
  - term: "Before You Start"
    definition: "Project 6 — and your arm must be built, with the arm motor plugged into port C . [Open the Arm Build Guide](/discovery/spike/builds/arm) — *Build guide coming soon — ask your teacher if this link is not live yet*"
---
