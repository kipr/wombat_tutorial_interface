...
weight: 12
nav: "introductory"
mission_id: "introductory_ev3_coding_12"
mission_title: "Introductory Project 12 (EV3) — Teaching Your Robot New Moves"
...
eyebrow: "Introductory · EV3 Coding Project 12"
...
meta:
  ...
  - term: "Before You Start"
    definition: "Project 11 — your gyro turn must already work, and your measuring card must be filled in."
---
## Try It --- Brain Dump
...
A `drive forward` block that always drives 3.5 rotations is fine until you need half that. And there is a second annoyance hiding with it: every time you drive, *you* are doing the inches-to-rotations math from Project 4 by hand.
...
{{< callout title="New Piece: the Green ÷ Oval" variant="gold" >}}
In the green **Operators** category there is an oval with a **÷** in it and two holes. It divides the first number by the second --- and like every oval, it drops into any white number hole. Which means your block's meaning can do the Project 4 math *itself*: inches ÷ your inches-per-rotation. Do the arithmetic once, in the define, and never again.
{{< /callout >}}

{{< wordblocks aria="define drive forward inches: move for inches divided by inches-per-rotation rotations" >}}
rows:
  - block:
      category: myblocks
      shape: hat
  ...
  - block:
      ...
      parts:
        ...
        - slot:
            kind: dropdown
            text: "rotations"
      note: "the input oval, divided by your inches-per-rotation"
{{< /wordblocks >}}
  ...
  - block:
      ...
      parts:
        ...
        - slot:
            kind: value
            text: "24"
      note: "go 24 inches --- the block does the math"
  - block:
      category: myblocks
      parts:
        - text: "drive forward "
        - slot:
            kind: value
            text: "12"
      note: "go 12 --- same block, new number"
{{< /wordblocks >}}
