...
weight: 6
nav: "introductory"
mission_id: "introductory_ev3_coding_06"
mission_title: "Introductory Project 6 (EV3) — Bulldoze Run"
...
eyebrow: "Introductory · EV3 Coding Project 6"
...
build_gate:
  ...
  description: "Everything from Project 7 onward needs a motorized arm with a claw on the end — arm motor in port A, claw motor in port D. The EV3 build guides are on their way; ask your teacher if the links are not live yet."
  links:
    - page: "/introductory/ev3/builds/arm"
      label: "Arm build guide"
    - page: "/introductory/ev3/builds/claw"
...
But there is another kind of stop, and you have probably caused it by accident already: the program simply *ends* while the robot is still moving. When that happens, the brick cuts power to everything and the robot **coasts** --- it rolls on until friction wins.
...
Reset, and run a plain *move for 3.5 rotations* instead. Mark that spot too.
{{< /callout >}}
...
[Open the Arm Build Guide](/introductory/ev3/builds/arm) — *Build guide coming soon --- ask your teacher if this link is not live yet*
