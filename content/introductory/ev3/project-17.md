...
weight: 17
nav: "introductory"
mission_id: "introductory_ev3_coding_17"
mission_title: "Introductory Project 17 (EV3) — Repeating Without Retyping"
...
eyebrow: "Introductory · EV3 Coding Project 17"
...
{{< wordblocks aria="Counter loop: set climbed to 0, repeat until climbed past arm up: run A clockwise for 5 degrees, change climbed by 5" >}}
rows:
  - block:
      category: events
      shape: hat
  ...
  - block:
      ...
      parts:
        ...
        - slot:
            kind: value
            text: "0"
      note: "arm at home --- nothing climbed yet"
  - control:
      category: control
      head:
        - text: "repeat until "
...
{{< ask key="p1_vs_single" label="Versus single block" >}}How is this different from a single *run A ↻ for (arm up) degrees* block on its own?{{< /ask >}}
...
| a counter in the jaws | The number itself is doing work --- like *climbed* creeping upward in the smoother. The variable is not just counting trips; every value it passes through matters. |
