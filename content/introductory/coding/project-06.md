...
weight: 6
nav: introductory
mission_id: introductory_coding_06
mission_title: "Coding Project 6 — Bulldoze Run"
...
eyebrow: "Introductory · Coding Project 6"
...
build_gate:
  ...
  page: /introductory/systems/project-07
...
That has been fine so far. From the next project it will not be, because you are about to add an arm, and an
    arm changes where the weight sits. A robot that coasts is a robot that keeps creeping after you told it to stop.
...
rows:
  - cells:
      ...
      - key: p3_stop_ao_creep
        aria: "ao creep"
  - cells:
      - text: "the three-line freeze"
      - key: p3_stop_frz
        aria: "freeze stop position"
...
rows:
  - cells:
      ...
      - key: p4_best_time
        aria: "Best time"
  - cells:
      - text: "Total commands in my program"
      - key: p4_cmd_count
        aria: "Command count"
  - cells:
...
- key: p4_can_banner
  label: "My program uses comment banners so I can find each mission's code"
- key: p4_can_add_one
...
KIPR · Botball Explorer --- Introductory Projects · © KISS Institute for Practical Robotics 1997--2027
