...
weight: 15
nav: "introductory"
mission_id: "introductory_spike_coding_15"
mission_title: "Introductory Project 15 (SPIKE) — Following the Line"
...
eyebrow: "Introductory · SPIKE Coding Project 15"
...
New project called `Line Follow`. Build the two-choice loop from Learn It. Put the sensor on the **left** edge of a line and let it run until you press the force sensor.
