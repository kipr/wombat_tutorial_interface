...
weight: 14
nav: "introductory"
mission_id: "introductory_spike_coding_14"
mission_title: "Introductory Project 14 (SPIKE) — Seeing Light and Dark"
...
eyebrow: "Introductory · SPIKE Coding Project 14"
...
Your force sensor answers one question: *am I pressed?* Yes or no. Nothing else.

This one is different. Plug the **color sensor** into port **B** and write that on your card. Open the device view and switch the sensor to its **reflected light** reading. Then watch the number while you hold it over things.
...
{{< wordblocks aria="Three wait-until hexagons: pressed, yaw, reflected light" >}}
rows:
  - block:
      category: control
      parts:
...
Your match start has been a tap on the force sensor since Project 10. The same brightness trick gives you a second option: point a color sensor *up*, and wait until its reading **jumps** --- the moment a light comes on over it, or a flashlight hits it.
