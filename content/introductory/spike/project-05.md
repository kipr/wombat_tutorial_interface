...
weight: 5
nav: "introductory"
mission_id: "introductory_spike_coding_05"
mission_title: "Introductory Project 5 (SPIKE) — Learning to Turn"
...
eyebrow: "Introductory · SPIKE Coding Project 5"
...
Start a new project called `Turns`. Build one single move block --- **move (steering) for 24 in.** --- and keep the distance the same for every single run.
...
| the amount | **Sets how far along that path the robot travels** --- inches or degrees. It does not change the shape at all, only how much of it you get. |
