...
short_title: "Python 3.3"
hub_unit: 3
description: "Libraries and import — gather all your functions into one reusable Python module and pull it into any program."
weight: 160
nav: python
track: python
type: labs
...
meta:
  ...
  - term: "CS1 Concepts"
    definition: "Libraries · [[MODULE|Modules]] · import · Code Organization · Documentation"
  - term: "Game Context"
...
- text: |
    ...the IDE reaches into `yourname.py` and makes everything in it available here, just like KIPR's library. Because your library lives in the same project folder, Python knows where to find it.
{{< /concept >}}
...
columns:
  ...
  - head: Write it here
rows:
  - - text: your first name + .py
    - key: p3_filename
      aria: Library filename
      placeholder: e.g. maria.py
{{< /gridtable >}}
...
{{< ask key="p7_q1_library" label="Reflection 1" n=1 >}}What is a library, and what does the `import` line do?{{< /ask >}}

{{< ask key="p7_q2_sections" label="Reflection 2" n=2 >}}What two sections did you organize your library into, and in what order?{{< /ask >}}
