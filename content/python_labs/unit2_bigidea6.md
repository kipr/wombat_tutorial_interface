...
- Use your Phase 2 table to turn the stopping ET value back into an approximate distance, and [[PRINT|print]] it. Roughly how far away did the robot actually stop?
